...
<body>
    <div class="container">
        ...
        <form class="col-6 mx-auto mt-4" method="POST">
            ...
            <button type="submit" class="btn btn-primary" name="registrarse2" value="ok">Registrarse</button>
            <button type="submit" class="btn btn-danger float-right ml-auto" name="btncancelar2" value="no">Cancelar nuevo usuario</button>
        </form>
    </div>
</body>
</html>
